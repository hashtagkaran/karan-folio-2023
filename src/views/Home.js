            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <a href='https://figma.com/@hashtagkaran'>
                <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                  ...
                  <h2 className="text-lg text-white font-medium title-font mb-4"><s>Fiverr</s> (Figma)</h2>
                  <p className="leading-relaxed text-base">Figma creator: Assets, plugins, published for efficient design.</p>
                </div>
              </a>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <a href='https://figma.com/@hashtagkaran'>
                <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                  ...
                  <h2 className="text-lg text-white font-medium title-font mb-4"><s>Dribble</s> (Figma)</h2>
                  <p className="leading-relaxed text-base">Figma creator: Assets, plugins, published for efficient design.</p>
                </div>
              </a>
            </div>
