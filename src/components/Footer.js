      ...
      <div className="mx-auto max-w-screen-xl">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                ...
                <li className="mb-4">
                  <a
                    href="https://linkedin.com/company/2mp-club"
                    className="hover:underline"
                  >
                    Linkedin
                  </a>
                ...
                <li className="mb-4">
                  <a
                    href="https://instagram.com/javascriptcode"
                    className="hover:underline"
                  >
                    JavaScriptCode
                  </a>
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                ...
                <li className="mb-4">
                  <a
                    href="https://discord.gg/qYCaGnjsvx"
                    className="hover:underline"
                  >
                    Discord
                  </a>
                ...
                <li className="mb-4">
                  <a
                    href="https://instagram.com/hashtagkaran"
                    className="hover:underline"
                  >
                    Instagram
                  </a>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            {/*</a>*/}
            <a
              href="https://instagram.com/hashtagkarann"
            ...
            <a
              href="https://dribbble.com/hashtagkaran"
              className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
            >
              <svg
                className="w-5 h-5"
